...
- [ ] 1.2 Create `src/gpu/WebGPUContext.ts` — adapter, device, BC feature request, canvas config
- [ ] 1.3 Create `src/components/DropZone.tsx` — drag-drop EXR + "Try sample" button
- [ ] 1.4 Dark theme setup — backgrounds #0d0d0d/#1a1a1a, no saturated accents
...
- [ ] 4.1 `input-convert.wgsl` — Stage 4: ToLinearRec709(), 6 gamut matrices (TRANSPOSED), 10 transfer functions
- [ ] 4.2 `color-grade.wgsl` — Stage 5: DecodeInput, ApplyGradingLog, ApplyGradingLinear, 22 uniforms
